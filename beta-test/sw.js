const CACHE_NAME="wikaru-static-20260826-v1";
const SHELL=["./","./index.html","./assets/css/app.css","./assets/js/critical.js","./assets/js/data-loader.js","./assets/js/app.js","./assets/js/enhancements.js","./data/manifest.json","./data/reference-static.json","./manifest.webmanifest"];
